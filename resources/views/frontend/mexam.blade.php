        ...
        <section class="page_title ds s-pt-80 s-pb-80 s-pt-lg-130 s-pb-lg-90">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h1>Mock Exam: {{ App\Http\Controllers\Front\UserFrontController::GetCourseOnID($cid)->course_title }}</h1>
                        <ol class="breadcrumb">
    ...
    <section class="ls s-pt-55 s-pb-45 s-pt-lg-95 s-pb-lg-75 shop-order-received">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        <h3>Instructions for Taking the Mock Exam</h3><br />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="unit_prevnext"><div class="col-md-3"><a href="#" id="prev_unit" data-unit="159231" class="unit unit_button"><span>Previous Unit</span></a></div><div class="col-md-6"><a href="https://www.1training.org/members/boris-johnson/course/course-results/?action=159691" class="quiz_results_popup"><span>Check Results</span></a></div><div class="col-md-3"><a href="#" id="next_quiz" data-unit="159692" class="unit unit_button"><span>Proceed to Quiz</span></a></div></div>
                </div>
            </div>
        </div>
    </section>
